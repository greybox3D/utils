...
describe("transactionUpdate", () => {
	...
	const runTransactionTests = (parallel: boolean) => {
		describe(`${parallel ? "parallel" : "serial"} transaction updates`, () => {
			describe("basic updates", () => {
				...
				it("should handle empty updates array", async () => {
					await transactionUpdate({ db, table: users, tasks: [], parallel });
	...
	// Run all tests for both serial and parallel modes
	runTransactionTests(false);
	runTransactionTests(true);
});
